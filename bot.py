...
def main():
    ...
    app.add_handler(CallbackQueryHandler(lihat_video,           pattern=r"^lihat_video$"))
    app.add_handler(CallbackQueryHandler(detail_video,          pattern=r"^video_\d+$"))
    app.add_handler(CallbackQueryHandler(info_afiliasi,         pattern=r"^info_afiliasi$"))
    app.add_handler(CallbackQueryHandler(kembali,               pattern=r"^kembali$"))
    app.add_handler(CallbackQueryHandler(admin_stats,           pattern=r"^admin_stats$"))
    app.add_handler(CallbackQueryHandler(admin_daftar,          pattern=r"^admin_daftar$"))
    app.add_handler(CallbackQueryHandler(hapus_video,           pattern=r"^hapus_\d+$"))
    app.add_handler(CallbackQueryHandler(admin_post_ke_channel, pattern=r"^admin_post$"))
    app.add_handler(CallbackQueryHandler(post_video_ke_channel, pattern=r"^postch_\d+$"))
